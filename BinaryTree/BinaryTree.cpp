...
public:
    ...
    // Función para encontrar el nodo con el valor mínimo desde un nodo dado.
    ...
    // Función para encontrar el nodo con el valor mínimo en todo el árbol.
    Node<T>* Minimum()
    {
        return MinimumFromNode(root);
    }

    // Función para obtener el valor mínimo del árbol.
    T MinimumValue()
    {
        Node<T>* temp = Minimum();
        if (temp != nullptr)
    ...
    // Función para encontrar el nodo con el valor máximo desde un nodo dado.
    ...
    // Función para encontrar el nodo con el valor máximo en todo el árbol.
    Node<T>* Maximum()
    {
        return MaximumFromNode(root);
    }

    // Función para obtener el valor máximo del árbol.
    T MaximumValue()
    {
        Node<T>* temp = Maximum();
        if (temp != nullptr)
    ...
    // Función para buscar un valor en el árbol y devolver el nodo que lo contiene.
    ...
    // Función para encontrar el sucesor de un nodo dado.
    ...
    // Función recursiva para recorrer el árbol en orden (izquierda - raíz - derecha).
    ...
    // Función iterativa para recorrer el árbol en orden (izquierda - raíz - derecha).
    ...
    // Función recursiva para recorrer el árbol en preorden (raíz - izquierda - derecha).
    ...
    // Función iterativa para recorrer el árbol en preorden (raíz - izquierda - derecha).
    ...
    // Función recursiva para recorrer el árbol en postorden (izquierda - derecha - raíz).
    ...
    // Función iterativa para recorrer el árbol en postorden (izquierda - derecha - raíz).
